...
export const metadata: Metadata = {
  title: {
    template: "%s | 조은이플란트치과 속초점",
    default: "조은이플란트치과 속초점 - 언제 어디서나, 같은 마음으로 진료합니다",
  },
  description:
    "속초 조은이플란트치과는 임플란트, 턱관절치료, 사랑니발치, 충치치료 등 구강외과 전문의가 제공하는 종합 치과 진료 서비스입니다. 정확한 진단과 정직한 진료로 환자분들의 소중한 치아 건강을 지켜드립니다.",
  keywords: [
    "속초조은이플란트치과",
    "속초치과",
    "속초임플란트",
  ...
  creator: "조은이플란트치과 속초점",
  publisher: "조은이플란트치과 속초점",
  robots: {
    index: true,
    follow: true,
    googleBot: {
